...
<p>
I interested with Cyber Security, Web development and other techniques from which the end user can benefit now and in the near future; I worked as a software developer for digital agency. I take great care in the experience, architecture, and code quality of the things I build. Also, I am learning Cyber Security Application, so i can work with [Network Security], etc..
</p>
...
- 
    ...
    ![PyCharm](https://img.shields.io/badge/pycharm-143?style=for-the-badge&logo=pycharm&logoColor=black&color=darkgreen&labelColor=green)
